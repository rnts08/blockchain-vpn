...
func EnrichEndpoints(announcements []*ProviderAnnouncement) []*EnrichedVPNEndpoint {
	...
	for _, ann := range announcements {
		wg.Add(1)
		go func(announcement *ProviderAnnouncement) {
			defer wg.Done()
...
func measureLatency(endpoint *VPNEndpoint) time.Duration {
