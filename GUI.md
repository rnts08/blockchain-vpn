...
2.  **Routing Tables:**
    *   **Client Traffic:** The application creates a specific routing table for the Client VPN tunnel (`wg1`).
...
3.  **Firewall Rules (iptables/nftables):**
    ...
    *   **Forward:** Allow traffic from `wg0` (Provider Clients) to Physical Interface (Internet).
